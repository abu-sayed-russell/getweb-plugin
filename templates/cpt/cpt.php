<div class="wrap">
	<?php html_head( 'Post Type Generator' ); ?>
	<?php settings_errors(); ?>
  ...
  <div class="tab-content">
    <div id="tab-1" class="tab-pane <?php echo ! isset( $_POST["edit_post"] ) ? 'active' : '' ?>">
      <h4>Manage Your Custom Post Types</h4>
		<?php
		...
		foreach ( $options as $option ) {
			...
			settings_fields( 'getweb_plugin_cpt_settings' );
    ...
    <div id="tab-2" class="tab-pane <?php echo isset( $_POST["edit_post"] ) ? 'active' : '' ?>">
      <form method="post" action="options.php">
		  <?php
		  settings_fields( 'getweb_plugin_cpt_settings' );
		  do_settings_sections( 'getweb_cpt' );
    ...
    <div id="tab-3" class="tab-pane">
      <h4>Export Your Custom Post Types</h4>
