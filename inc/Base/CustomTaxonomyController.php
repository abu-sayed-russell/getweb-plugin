...
class CustomTaxonomyController extends BaseController
{
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'getweb_plugin_tax_settings',
				'option_name' => 'getweb_plugin_tax',
	...
	public function setSections()
	{
		$args = array(
			array(
				'id' => 'getweb_tax_index',
				'title' => '<h4>Custom Taxonomy Manager</h4>',
				'callback' => '',
				'page' => 'getweb_taxonomy'
			)
		);
	...
	public function storeCustomTaxonomies()
	{
		...
		foreach ($options as $option) {
			...
			$this->taxonomies[] = array(
				...
				'show_in_rest'      => $option['has_gutenberg'] == 1  ? true : false,
				'query_var'         => true,
