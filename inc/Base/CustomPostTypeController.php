...
class CustomPostTypeController extends BaseController
{
  ...
  public function setSettings()
  {
    $args = array(
      array(
        'option_group' => 'getweb_plugin_cpt_settings',
        'option_name' => 'getweb_plugin_cpt',
  ...
  public function setSections()
  {
    $args = array(
      array(
        'id' => 'getweb_cpt_index',
        'title' => '<h4>Custom Post Type Manager</h4>',
  ...
  public function setFields()
  {
    $args = array(
      ...
      array(
        'id' => 'title',
        'title' => 'Support Title',
        'callback' => array( $this->cpt_callbacks, 'checkboxTitle' ),
        'page' => 'getweb_cpt',
        'section' => 'getweb_cpt_index',
        'args' => array(
          'option_name' => 'getweb_plugin_cpt',
      ...
      array(
        ...
        'callback' => array( $this->cpt_callbacks, 'checkboxEditor' ),
        'page' => 'getweb_cpt',
        'section' => 'getweb_cpt_index',
        'args' => array(
          'option_name' => 'getweb_plugin_cpt',
      ...
      array(
        ...
        'callback' => array( $this->cpt_callbacks, 'checkboxAuthor' ),
        'page' => 'getweb_cpt',
        'section' => 'getweb_cpt_index',
        'args' => array(
          'option_name' => 'getweb_plugin_cpt',
      ...
      array(
        ...
        'callback' => array( $this->cpt_callbacks, 'checkboxThumbnail' ),
        'page' => 'getweb_cpt',
        'section' => 'getweb_cpt_index',
        'args' => array(
          'option_name' => 'getweb_plugin_cpt',
      ...
      array(
        ...
        'callback' => array( $this->cpt_callbacks, 'checkboxExcerpt' ),
        'page' => 'getweb_cpt',
        'section' => 'getweb_cpt_index',
        'args' => array(
          'option_name' => 'getweb_plugin_cpt',
      ...
      array(
        ...
        'callback' => array( $this->cpt_callbacks, 'checkboxCustomField' ),
        'page' => 'getweb_cpt',
        'section' => 'getweb_cpt_index',
        'args' => array(
          'option_name' => 'getweb_plugin_cpt',
      ...
      array(
        ...
        'callback' => array( $this->cpt_callbacks, 'checkboxComments' ),
        'page' => 'getweb_cpt',
        'section' => 'getweb_cpt_index',
        'args' => array(
          'option_name' => 'getweb_plugin_cpt',
  ...
  {
    $options = get_option( 'getweb_plugin_cpt' ) ?: array();
